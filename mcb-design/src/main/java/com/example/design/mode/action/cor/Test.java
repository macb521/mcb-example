...
public class Test {
    public static void main(String[] args) {
        //辅导员
        AbstractLeader instructor = new Instructor("陈毅");
        //系主任
        AbstractLeader departmentHead = new DepartmentHead("王明");
        //院长
        AbstractLeader dean = new Dean("张强");
        //校长
        AbstractLeader president = new President("王晗");
